...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let u3 = Urunler(urun_id: 3, urun_ad: "Sony ZX Series", urun_resim_ad: "kulaklik", urun_fiyat: 489.9)
        let u4 = Urunler(urun_id: 4, urun_ad: "Gio Armani", urun_resim_ad: "parfum", urun_fiyat: 769.99)
        let u5 = Urunler(urun_id: 5, urun_ad: "Casio X Series", urun_resim_ad: "saat", urun_fiyat: 169.9)
        let u6 = Urunler(urun_id: 6, urun_ad: "Dyson V8", urun_resim_ad: "supurge", urun_fiyat: 3799.9)
        let u7 = Urunler(urun_id: 7, urun_ad: "İphone 13 Pro", urun_resim_ad: "telefon", urun_fiyat: 13499.99)
...
// 6.adım Protocolu view Controlle ekle
extension ViewController : UITableViewDelegate,UITableViewDataSource,HucreProtocol{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.urunResimİmageView.image = UIImage(named: urun.urun_resim_ad!)
        ...
        // 8.adım yetki verme ve indexxpath verisini iletme
